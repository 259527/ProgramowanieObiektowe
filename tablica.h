...
*
* Generuje tablicę wyświetlając jej wartości w komórkach
*
* @param[in] tablica pobiera tablicę aby ją wyświetlić
* @param[in] rozX pobiera szerokość tablicy
* @param[in] rozY pobiera wysokość tablicy
*/
void wyswietlTablice(int** tablica, int rozX, int rozY);
